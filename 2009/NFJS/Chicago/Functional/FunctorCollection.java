...
public class FunctorCollection<E>
    implements Collection<E>, Iterable<E>
{
    private ArrayList<E> list;
    
    public Predicate<E> onAdd;
    public Predicate<E> onRemove;
        
    public ArraySortedCollection(Collection<? extends E> src)
    {
