...
let johnsfunction x y = (x + x) + y
let johnsfunction2 (x, y) = (x + x) + y


let result = johnsfunction 1.0 2.0
...
let amandaList = [1..1000000000]

let amandaList1 = [1..2..10]
