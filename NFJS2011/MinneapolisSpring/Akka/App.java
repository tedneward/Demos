...
public class App
{
        ...
        throws Throwable
    {
        ...
        //actor.sendOneWay(new Hello("Is it you I'm looking for?"));
        try
        {
            Object result = actor.sendRequestReply(new Hello("Is it you I'm looking for?"), 1000, actor);
        ...
        Future f = actor.sendRequestReplyFuture(new Hello("Is it you I'm looking for?"), 1000, actor);
        while (!f.isCompleted())
        {
            System.out.print(".");
        }
