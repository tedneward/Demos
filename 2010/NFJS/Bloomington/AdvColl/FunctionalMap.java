...
class CompositeGetFn<K,V>
    implements GetFn<K,V>
{
    final GetFn<K,V>[] fns;
    public CompositeGetFn(GetFn... fns)
    {
        this.fns = fns;
    }
...
class CompositePutFn<K,V>
    implements PutFn<K,V>
{
    final PutFn<K,V>[] fns;
    public CompositePutFn(PutFn... fns)
    {
        this.fns = fns;
    }
