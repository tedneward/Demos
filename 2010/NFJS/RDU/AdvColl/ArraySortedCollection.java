...
/*
public class BehaviorCollection<E>
    extends ForwardingCollection<E>
{
    this.validator = new Predicate<E>() {
        public boolean apply(E it) {
            return true;
        }
    };
    
    public BehaviorCollection<E>(Predicate<E> validationFn)
    {
        this.validator = validationFn;
    }
    
    private ArrayList<E> list = new ArrayList<E>();
    
    protected Collection<E> delegate() { return list; }

    private boolean test(E e) { return validator.apply(e); }
    
    public boolean add(E e)
    { 
        if (test(e)) { return delegate().add(e); }
    }
}
*/
